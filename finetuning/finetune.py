...
def train(
    ...
    if with_speedup_desc:
        prompter = Prompter(template_name="code_opt_w_speedup_desc")
    elif with_speedup_bin:
        prompter = Prompter(template_name="code_opt_w_speedup_bin")
    elif with_pctile: 
